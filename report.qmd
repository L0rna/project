...
Prepared data were also subset to columns of interest 'stem_diameter', 'height' and 'growth' and subset to complete cas. Liana growth forms
...
@fig-growth-forms-counts shows the distribution of individual counts across growth forms.
